...
def reframe(data, input_win_size, output_win_size, stride_size, n_i):
    ...
    for i in range(n_i):
        ...
        output[i*n_windows : (i+1) * n_windows,:,5] = embed_indicator
        ...
        for j in range(n_windows):
            ...
            output[i*n_windows + j,:-1,4] = ground_truth
            output[i*n_windows + j,-1,4] = output[i*n_windows + j,-1,0]
